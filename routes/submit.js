...
const calculateMinerFee = function(RECIPIENT_COUNT, CONTRIBUTION_COUNT)
{
	...
	const MINER_FEE = (TRANSACTION_METADATA_BYTES + (AVERAGE_BYTE_PER_RECIPIENT * RECIPIENT_COUNT) + (AVERAGE_BYTE_PER_CONTRIBUTION * (CONTRIBUTION_COUNT + 1))) * TARGET_FEE_RATE;
